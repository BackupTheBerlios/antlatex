...
\item Die Erweiterung \code{figbib} für kommentierte Abbildungsverzeichnisse wird unterstüzt.
\end{itemize}
...
\code{figbib} & Schalter für die Vewendung des Package \emph{figbib} & Nein. Default: off\\
\end{supertabular}
}
...
\code{makeindex} & Makeindex-Element & Nein\\
\code{bibtex}    & \BibTeX{}-Element & Nein\\
\code{jxGlosstex} &\\
